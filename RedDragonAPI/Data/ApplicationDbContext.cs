...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedTechnologyDefinitions(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TechnologyDefinition>().HasData(
            // === 1-LEVEL (standalone) ===
            new TechnologyDefinition { Id = 1, TechType = "KonstrukcjaMaszyn", Category = "Ekonomia", DisplayName = "Konstrukcja maszyn drewnianych", Description = "Odblokowanie machin wojennych", Level = 1, CostGold = 3000, ResearchTime = 5, CostScience = 2_000_000, EffectType = "UnlockSiege", EffectValue = 1.0m },
            new TechnologyDefinition { Id = 2, TechType = "Empiryzm", Category = "Nauka", DisplayName = "Empiryzm", Description = "Bonus do efektywności naukowców", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 5_000_000, EffectType = "ScienceBonus", EffectValue = 0.10m },
            // === 2-LEVEL CHAIN: Czas ===
            new TechnologyDefinition { Id = 3, TechType = "ZakrzywCzasu", Category = "Czas", DisplayName = "Zakrzywienie czasu", Description = "+1 tura dziennie", Level = 1, CostGold = 20000, ResearchTime = 15, CostScience = 300_000, EffectType = "BonusTurns", EffectValue = 1.0m },
            new TechnologyDefinition { Id = 4, TechType = "ZalamCzasu", Category = "Czas", DisplayName = "Załamanie czasu", Description = "+1 dodatkowa tura dziennie", Level = 2, CostGold = 50000, ResearchTime = 25, CostScience = 300_000, RequiredTech = "ZakrzywCzasu", EffectType = "BonusTurns", EffectValue = 1.0m },
            // === 3-LEVEL CHAINS ===
            // Rekultywacja
            new TechnologyDefinition { Id = 5, TechType = "Rekultywacja", Category = "Ziemia", DisplayName = "Rekultywacja", Description = "Tańsze kupowanie ziemi", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 300_000, EffectType = "LandCostReduction", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 6, TechType = "Osadnictwo", Category = "Ziemia", DisplayName = "Osadnictwo", Description = "Jeszcze tańsza ziemia", Level = 2, CostGold = 15000, ResearchTime = 15, CostScience = 3_000_000, RequiredTech = "Rekultywacja", EffectType = "LandCostReduction", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 7, TechType = "GornictwoOdkrywkowe", Category = "Ziemia", DisplayName = "Górnictwo Odkrywkowe", Description = "Bonus do kamienia", Level = 3, CostGold = 30000, ResearchTime = 20, CostScience = 6_000_000, RequiredTech = "Osadnictwo", EffectType = "StoneBonus", EffectValue = 0.30m },
            // Smokoastronomia
            new TechnologyDefinition { Id = 8, TechType = "Smokoastronomia", Category = "Smoki", DisplayName = "Smokoastronomia", Description = "Podstawowa wiedza o smokach", Level = 1, CostGold = 8000, ResearchTime = 10, CostScience = 2_000_000, EffectType = "DragonKnowledge", EffectValue = 1.0m },
            new TechnologyDefinition { Id = 9, TechType = "Smokoanatomia", Category = "Smoki", DisplayName = "Smokoanatomia", Description = "Znajomość anatomii smoków", Level = 2, CostGold = 20000, ResearchTime = 18, CostScience = 3_000_000, RequiredTech = "Smokoastronomia", EffectType = "DragonKnowledge", EffectValue = 2.0m },
            new TechnologyDefinition { Id = 10, TechType = "Smokodynamika", Category = "Smoki", DisplayName = "Smokodynamika", Description = "Pełna kontrola nad smokami", Level = 3, CostGold = 45000, ResearchTime = 25, CostScience = 4_000_000, RequiredTech = "Smokoanatomia", EffectType = "DragonKnowledge", EffectValue = 3.0m },
            // Rachunkowość
            new TechnologyDefinition { Id = 11, TechType = "Rachunkowosc", Category = "Ekonomia", DisplayName = "Rachunkowość", Description = "Bonus do złota z kupców", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 2_000_000, EffectType = "MerchantBonus", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 12, TechType = "Buchalteria", Category = "Ekonomia", DisplayName = "Buchalteria", Description = "Większy bonus do handlu", Level = 2, CostGold = 15000, ResearchTime = 15, CostScience = 4_000_000, RequiredTech = "Rachunkowosc", EffectType = "MerchantBonus", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 13, TechType = "Ksiegowosc", Category = "Ekonomia", DisplayName = "Księgowość", Description = "Maksymalny bonus handlowy", Level = 3, CostGold = 35000, ResearchTime = 22, CostScience = 6_000_000, RequiredTech = "Buchalteria", EffectType = "MerchantBonus", EffectValue = 0.30m },
            // Ostrzenie broni
            new TechnologyDefinition { Id = 14, TechType = "OstrzenieBroni", Category = "Wojsko", DisplayName = "Ostrzenie broni", Description = "Bonus do ataku", Level = 1, CostGold = 8000, ResearchTime = 10, CostScience = 2_000_000, EffectType = "AttackBonus", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 15, TechType = "NaprawaBroni", Category = "Wojsko", DisplayName = "Naprawa broni", Description = "Większy bonus do ataku", Level = 2, CostGold = 20000, ResearchTime = 18, CostScience = 4_000_000, RequiredTech = "OstrzenieBroni", EffectType = "AttackBonus", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 16, TechType = "PrzekuwanieBroni", Category = "Wojsko", DisplayName = "Przekuwanie broni", Description = "Maksymalny bonus do ataku", Level = 3, CostGold = 45000, ResearchTime = 25, CostScience = 6_000_000, RequiredTech = "NaprawaBroni", EffectType = "AttackBonus", EffectValue = 0.30m },
            // === 5-LEVEL CHAINS (progi: 0,3M / 3M / 9M / 15M / 21M) ===
            // Wynalazczość (Rozwój — w manualu podnosi limit SP/turę)
            new TechnologyDefinition { Id = 17, TechType = "Wynalazki1", Category = "Nauka", DisplayName = "Wynalazczość I", Description = "Bonus do produkcji i wyższy limit SP/turę", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 300_000, EffectType = "ProductionBonus", EffectValue = 0.05m },
            new TechnologyDefinition { Id = 18, TechType = "Wynalazki2", Category = "Nauka", DisplayName = "Wynalazczość II", Level = 2, CostGold = 12000, ResearchTime = 12, CostScience = 3_000_000, RequiredTech = "Wynalazki1", EffectType = "ProductionBonus", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 19, TechType = "Wynalazki3", Category = "Nauka", DisplayName = "Wynalazczość III", Level = 3, CostGold = 25000, ResearchTime = 18, CostScience = 9_000_000, RequiredTech = "Wynalazki2", EffectType = "ProductionBonus", EffectValue = 0.15m },
            new TechnologyDefinition { Id = 20, TechType = "Wynalazki4", Category = "Nauka", DisplayName = "Wynalazczość IV", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 15_000_000, RequiredTech = "Wynalazki3", EffectType = "ProductionBonus", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 21, TechType = "Wynalazki5", Category = "Nauka", DisplayName = "Wynalazczość V", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 21_000_000, RequiredTech = "Wynalazki4", EffectType = "ProductionBonus", EffectValue = 0.25m },
            // Architektura (reduces special building costs)
            new TechnologyDefinition { Id = 22, TechType = "Architektura1", Category = "Budowa", DisplayName = "Architektura I", Description = "Tańsze budynki specjalne", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 300_000, EffectType = "SpecialBuildingCostReduction", EffectValue = 0.05m },
            new TechnologyDefinition { Id = 23, TechType = "Architektura2", Category = "Budowa", DisplayName = "Architektura II", Level = 2, CostGold = 12000, ResearchTime = 12, CostScience = 3_000_000, RequiredTech = "Architektura1", EffectType = "SpecialBuildingCostReduction", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 24, TechType = "Architektura3", Category = "Budowa", DisplayName = "Architektura III", Level = 3, CostGold = 25000, ResearchTime = 18, CostScience = 9_000_000, RequiredTech = "Architektura2", EffectType = "SpecialBuildingCostReduction", EffectValue = 0.15m },
            new TechnologyDefinition { Id = 25, TechType = "Architektura4", Category = "Budowa", DisplayName = "Architektura IV", Description = "Brak kosztu złota pod czarną magią + 50% taniej przyspieszanie", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 15_000_000, RequiredTech = "Architektura3", EffectType = "SpecialBuildingCostReduction", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 26, TechType = "Architektura5", Category = "Budowa", DisplayName = "Architektura V", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 21_000_000, RequiredTech = "Architektura4", EffectType = "SpecialBuildingCostReduction", EffectValue = 0.25m },
            // Inżynieria (reduces economic building gold cost)
            new TechnologyDefinition { Id = 27, TechType = "Inzynieria1", Category = "Budowa", DisplayName = "Inżynieria I", Description = "Tańsze budynki gospodarcze", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 300_000, EffectType = "EcoBuildingCostReduction", EffectValue = 0.05m },
            new TechnologyDefinition { Id = 28, TechType = "Inzynieria2", Category = "Budowa", DisplayName = "Inżynieria II", Level = 2, CostGold = 12000, ResearchTime = 12, CostScience = 3_000_000, RequiredTech = "Inzynieria1", EffectType = "EcoBuildingCostReduction", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 29, TechType = "Inzynieria3", Category = "Budowa", DisplayName = "Inżynieria III", Level = 3, CostGold = 25000, ResearchTime = 18, CostScience = 9_000_000, RequiredTech = "Inzynieria2", EffectType = "EcoBuildingCostReduction", EffectValue = 0.15m },
            new TechnologyDefinition { Id = 30, TechType = "Inzynieria4", Category = "Budowa", DisplayName = "Inżynieria IV", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 15_000_000, RequiredTech = "Inzynieria3", EffectType = "EcoBuildingCostReduction", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 31, TechType = "Inzynieria5", Category = "Budowa", DisplayName = "Inżynieria V", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 21_000_000, RequiredTech = "Inzynieria4", EffectType = "EcoBuildingCostReduction", EffectValue = 0.25m },
            // Czarodziejstwo
            new TechnologyDefinition { Id = 32, TechType = "Czarodziejstwo1", Category = "Magia", DisplayName = "Czarodziejstwo I", Description = "Tańsze rzucanie zaklęć", Level = 1, CostGold = 8000, ResearchTime = 10, CostScience = 300_000, EffectType = "SpellPower", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 33, TechType = "Czarodziejstwo2", Category = "Magia", DisplayName = "Czarodziejstwo II", Level = 2, CostGold = 18000, ResearchTime = 16, CostScience = 3_000_000, RequiredTech = "Czarodziejstwo1", EffectType = "SpellPower", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 34, TechType = "Czarodziejstwo3", Category = "Magia", DisplayName = "Czarodziejstwo III", Level = 3, CostGold = 35000, ResearchTime = 22, CostScience = 9_000_000, RequiredTech = "Czarodziejstwo2", EffectType = "SpellPower", EffectValue = 0.30m },
            new TechnologyDefinition { Id = 35, TechType = "Czarodziejstwo4", Category = "Magia", DisplayName = "Czarodziejstwo IV", Level = 4, CostGold = 55000, ResearchTime = 28, CostScience = 15_000_000, RequiredTech = "Czarodziejstwo3", EffectType = "SpellPower", EffectValue = 0.40m },
            new TechnologyDefinition { Id = 36, TechType = "Czarodziejstwo5", Category = "Magia", DisplayName = "Czarodziejstwo V", Level = 5, CostGold = 90000, ResearchTime = 38, CostScience = 21_000_000, RequiredTech = "Czarodziejstwo4", EffectType = "SpellPower", EffectValue = 0.50m },
            // Trening
            new TechnologyDefinition { Id = 37, TechType = "Trening1", Category = "Wojsko", DisplayName = "Trening I", Description = "Szybsze szkolenie wojsk", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 300_000, EffectType = "TrainingSpeed", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 38, TechType = "Trening2", Category = "Wojsko", DisplayName = "Trening II", Level = 2, CostGold = 12000, ResearchTime = 12, CostScience = 3_000_000, RequiredTech = "Trening1", EffectType = "TrainingSpeed", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 39, TechType = "Trening3", Category = "Wojsko", DisplayName = "Trening III", Level = 3, CostGold = 25000, ResearchTime = 18, CostScience = 9_000_000, RequiredTech = "Trening2", EffectType = "TrainingSpeed", EffectValue = 0.30m },
            new TechnologyDefinition { Id = 40, TechType = "Trening4", Category = "Wojsko", DisplayName = "Trening IV", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 15_000_000, RequiredTech = "Trening3", EffectType = "TrainingSpeed", EffectValue = 0.40m },
            new TechnologyDefinition { Id = 41, TechType = "Trening5", Category = "Wojsko", DisplayName = "Trening V", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 21_000_000, RequiredTech = "Trening4", EffectType = "TrainingSpeed", EffectValue = 0.50m },
            // Rekrutacja
            new TechnologyDefinition { Id = 42, TechType = "Rekrutacja1", Category = "Wojsko", DisplayName = "Rekrutacja I", Description = "Tańsza rekrutacja złodziei", Level = 1, CostGold = 5000, ResearchTime = 8, CostScience = 300_000, EffectType = "RecruitCostReduction", EffectValue = 0.05m },
            new TechnologyDefinition { Id = 43, TechType = "Rekrutacja2", Category = "Wojsko", DisplayName = "Rekrutacja II", Level = 2, CostGold = 12000, ResearchTime = 12, CostScience = 3_000_000, RequiredTech = "Rekrutacja1", EffectType = "RecruitCostReduction", EffectValue = 0.10m },
            new TechnologyDefinition { Id = 44, TechType = "Rekrutacja3", Category = "Wojsko", DisplayName = "Rekrutacja III", Level = 3, CostGold = 25000, ResearchTime = 18, CostScience = 9_000_000, RequiredTech = "Rekrutacja2", EffectType = "RecruitCostReduction", EffectValue = 0.15m },
            new TechnologyDefinition { Id = 45, TechType = "Rekrutacja4", Category = "Wojsko", DisplayName = "Rekrutacja IV", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 15_000_000, RequiredTech = "Rekrutacja3", EffectType = "RecruitCostReduction", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 46, TechType = "Rekrutacja5", Category = "Wojsko", DisplayName = "Rekrutacja V", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 21_000_000, RequiredTech = "Rekrutacja4", EffectType = "RecruitCostReduction", EffectValue = 0.25m }
        );
    }
