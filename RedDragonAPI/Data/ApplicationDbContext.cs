...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedBuildingDefinitions(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BuildingDefinition>().HasData(
            ...
            new BuildingDefinition { Id = 15, BuildingType = "Uniwersytety", Category = "Cechy", DisplayName = "Uniwersytety", Description = "Zwiększa produktywność naukowców (bonus rośnie z liczbą uniwersytetów)", CostGold = 200, CostBudulec = 1, CostLand = 1, BuildTime = 1, ProductionBonus = 0.05m },
            new BuildingDefinition { Id = 16, BuildingType = "Kamieniolom", Category = "Manufaktury", DisplayName = "Kamieniołom", Description = "Automatycznie wydobywa kamień bez pracowników", CostGold = 300, CostBudulec = 1, CostLand = 1, BuildTime = 1 },
            new BuildingDefinition { Id = 17, BuildingType = "KopalniaDiamentow", Category = "Manufaktury", DisplayName = "Diamentowa kopalnia", Description = "Automatycznie wydobywa złoto bez pracowników", CostGold = 300, CostBudulec = 1, CostLand = 1, BuildTime = 1 },
            new BuildingDefinition { Id = 18, BuildingType = "ManoweJeziorko", Category = "Manufaktury", DisplayName = "Manowe jeziorko", Description = "Automatycznie produkuje manę bez pracowników", CostGold = 300, CostBudulec = 1, CostLand = 1, BuildTime = 1 },
            ...
            new BuildingDefinition { Id = 106, BuildingType = "Szaniec", Category = "Specjalne", DisplayName = "Szaniec", Description = "Obrona +5%, straty ludności broniącej mniejsze o 20%", IsSpecial = true, Row = 1, Col = 6, BaseCost = 500, BuildTime = 1, CostLand = 0, DefenseBonus = 0.05m },
            ...
            new BuildingDefinition { Id = 205, BuildingType = "Szpital", Category = "Specjalne", DisplayName = "Szpital", Description = "Straty wojska w obronie mniejsze o 25%", IsSpecial = true, Row = 2, Col = 5, BaseCost = 5000, BuildTime = 2, CostLand = 0, RequiredBuildingType = "SztabUderzeniowy" },
            new BuildingDefinition { Id = 206, BuildingType = "SmoczyMur", Category = "Specjalne", DisplayName = "Smoczy mur", Description = "Podnosi siłę obrony księstwa o 10%", IsSpecial = true, Row = 2, Col = 6, BaseCost = 5000, BuildTime = 2, CostLand = 0, RequiredBuildingType = "Szaniec", DefenseBonus = 0.10m },
            ...
            new BuildingDefinition { Id = 306, BuildingType = "SmoczaBariera", Category = "Specjalne", DisplayName = "Smocza bariera", Description = "Druga linia umocnień — obrona +10%", IsSpecial = true, Row = 3, Col = 6, BaseCost = 20000, BuildTime = 3, CostLand = 0, RequiredBuildingType = "SmoczyMur", DefenseBonus = 0.10m },
            ...
            new BuildingDefinition { Id = 406, BuildingType = "Zamek", Category = "Specjalne", DisplayName = "Zamek", Description = "Obrona +15% (także w paktach), straty ludności cywilnej −10%", IsSpecial = true, Row = 4, Col = 6, BaseCost = 50000, BuildTime = 4, CostLand = 0, RequiredBuildingType = "SmoczaBariera", DefenseBonus = 0.15m },
            ...
            new BuildingDefinition { Id = 505, BuildingType = "AkademiaWojskowa", Category = "Specjalne", DisplayName = "Akademia wojskowa", Description = "+5 p.p. awansu E1→E2 na turę (Olbrzym 6, Goblin 4,5); podwaja też szansę przyjścia generała", IsSpecial = true, Row = 5, Col = 5, BaseCost = 85000, BuildTime = 5, CostLand = 0, RequiredBuildingType = "PlacDefilad" },
            new BuildingDefinition { Id = 506, BuildingType = "SiecFortec", Category = "Specjalne", DisplayName = "Sieć wojennych fortec", Description = "Po przełamaniu obrony kolejne ataki zabierają 6/6/6/4,5/3/1,5% ziemi zamiast 10/10/8/6/4/2%", IsSpecial = true, Row = 5, Col = 6, BaseCost = 85000, BuildTime = 5, CostLand = 0, RequiredBuildingType = "Zamek", DefenseBonus = 0m },
            new BuildingDefinition { Id = 507, BuildingType = "PortTowarowy", Category = "Specjalne", DisplayName = "Port towarowy", Description = "400–600 tys. złota na turę, w czasie wojny podwójnie", IsSpecial = true, Row = 5, Col = 7, BaseCost = 85000, BuildTime = 5, CostLand = 0, RequiredBuildingType = "SkrzyzowanieSzlakow" },
            ...
            new BuildingDefinition { Id = 605, BuildingType = "KoszarySpecjalne", Category = "Specjalne", DisplayName = "Koszary", Description = "Umożliwia rekrutację E2; przy włączonym szkoleniu +10 p.p. awansu hoplitów do E1 na turę", IsSpecial = true, Row = 6, Col = 5, BaseCost = 110000, BuildTime = 6, CostLand = 0, RequiredBuildingType = "AkademiaWojskowa" },
            new BuildingDefinition { Id = 606, BuildingType = "PospoliteRuszenie", Category = "Specjalne", DisplayName = "Pospolite ruszenie", Description = "Cała ludność cywilna i złodzieje bronią księstwa ze współczynnikiem 2 (Goblin 3, Olbrzym 2,5, Br-Oug 1,5, Gnom 1)", IsSpecial = true, Row = 6, Col = 6, BaseCost = 110000, BuildTime = 6, CostLand = 0, RequiredBuildingType = "SiecFortec", DefenseBonus = 0m },
            ...
            // === BUDYNKI SPECJALNE - Kolumna 7 (budynki uzupełnione wg Dracopedii/manuala §14.3) ===
            new BuildingDefinition { Id = 107, BuildingType = "Komando", Category = "Specjalne", DisplayName = "Komando", Description = "Oddziały szybkiego reagowania — straty cywilów przy wrogich atakach mniejsze o 20%", IsSpecial = true, Row = 1, Col = 7, BaseCost = 500, BuildTime = 1, CostLand = 0 },
            new BuildingDefinition { Id = 207, BuildingType = "NawiedzonyLas", Category = "Specjalne", DisplayName = "Nawiedzony las", Description = "Klątwa na przygranicznych lasach — 5% armii inwazyjnej ucieka przed walką", IsSpecial = true, Row = 2, Col = 7, BaseCost = 5000, BuildTime = 2, CostLand = 0, RequiredBuildingType = "Komando" },
            new BuildingDefinition { Id = 307, BuildingType = "AmbulatoriumPolowe", Category = "Specjalne", DisplayName = "Ambulatorium polowe", Description = "Mobilny lazaret — straty własnej armii w ataku mniejsze o 50%", IsSpecial = true, Row = 3, Col = 7, BaseCost = 50000, BuildTime = 4, CostLand = 0, RequiredBuildingType = "NawiedzonyLas" },
            new BuildingDefinition { Id = 407, BuildingType = "Zamtuz", Category = "Specjalne", DisplayName = "Zamtuz pod Smoczym Ogonem", Description = "+25% przyrostu nowych poddanych (nie zwiększa pojemności księstwa)", IsSpecial = true, Row = 4, Col = 7, BaseCost = 50000, BuildTime = 4, CostLand = 0, RequiredBuildingType = "AmbulatoriumPolowe" },
            new BuildingDefinition { Id = 607, BuildingType = "Palac", Category = "Specjalne", DisplayName = "Pałac", Description = "+1 ataku dla elity 2. stopnia; ranni generałowie wracają do sił 2× szybciej", IsSpecial = true, Row = 6, Col = 7, BaseCost = 85000, BuildTime = 5, CostLand = 0, RequiredBuildingType = "PortTowarowy" }
        );
    }
    ...
    private void SeedTechnologyDefinitions(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TechnologyDefinition>().HasData(
            ...
            new TechnologyDefinition { Id = 25, TechType = "Architektura4", Category = "Budowa", DisplayName = "Architektura zaawansowana", Description = "U Enta zmniejsza cenę budynków specjalnych o 21%. (Efekty oryginału — 3. rząd bez złota i tańsze przyspieszanie — nie mają odpowiednika: budynki specjalne kosztują tu wyłącznie budulec.)", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 15_000_000, RequiredTech = "Architektura3", EffectType = "SpecialBuildingCostReduction", EffectValue = 0.15m },
            new TechnologyDefinition { Id = 26, TechType = "Architektura5", Category = "Budowa", DisplayName = "Architektura nowoczesna", Description = "Budynki 6. i 7. rzędu budują się o turę szybciej (koszt budulca ×(t−1)/t). U Enta zmniejsza cenę budynków specjalnych o 30%.", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 21_000_000, RequiredTech = "Architektura4", EffectType = "SpecialBuildingCostReduction", EffectValue = 0.15m },
            ...
            new TechnologyDefinition { Id = 30, TechType = "Inzynieria4", Category = "Budowa", DisplayName = "Inżynieria zaawansowana", Description = "Murarze zużywają 10% mniej kamienia. U Elfa zamiast tego rabat 32% na złoto zabudowań. Ent nie ma dostępu.", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 12_000_000, RequiredTech = "Inzynieria3", EffectType = "EcoBuildingCostReduction", EffectValue = 0.24m },
            new TechnologyDefinition { Id = 31, TechType = "Inzynieria5", Category = "Budowa", DisplayName = "Inżynieria nowoczesna", Description = "Wyburzanie budynków zwraca 80% budulca. U Ożywieńców zamiast tego rabat 32% na złoto zabudowań. Ent nie ma dostępu.", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 12_000_000, RequiredTech = "Inzynieria4", EffectType = "EcoBuildingCostReduction", EffectValue = 0.24m },
            // Czarodziejstwo — zmniejsza cenę czarów (Dracopedia: 3/6/15/20/25%)
            new TechnologyDefinition { Id = 32, TechType = "Czarodziejstwo1", Category = "Magia", DisplayName = "Czarodziejstwo prymitywne", Description = "Zmniejsza cenę czarów o 3%.", Level = 1, CostGold = 8000, ResearchTime = 10, CostScience = 300_000, EffectType = "SpellPower", EffectValue = 0.03m },
            new TechnologyDefinition { Id = 33, TechType = "Czarodziejstwo2", Category = "Magia", DisplayName = "Czarodziejstwo podstawowe", Description = "Zmniejsza cenę czarów o 6%.", Level = 2, CostGold = 18000, ResearchTime = 16, CostScience = 3_000_000, RequiredTech = "Czarodziejstwo1", EffectType = "SpellPower", EffectValue = 0.06m },
            ...
            new TechnologyDefinition { Id = 35, TechType = "Czarodziejstwo4", Category = "Magia", DisplayName = "Czarodziejstwo zaawansowane", Description = "Zmniejsza cenę czarów o 20%.", Level = 4, CostGold = 55000, ResearchTime = 28, CostScience = 15_000_000, RequiredTech = "Czarodziejstwo3", EffectType = "SpellPower", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 36, TechType = "Czarodziejstwo5", Category = "Magia", DisplayName = "Czarodziejstwo nowoczesne", Description = "Zmniejsza cenę czarów o 25%.", Level = 5, CostGold = 90000, ResearchTime = 38, CostScience = 21_000_000, RequiredTech = "Czarodziejstwo4", EffectType = "SpellPower", EffectValue = 0.25m },
            ...
            new TechnologyDefinition { Id = 45, TechType = "Rekrutacja4", Category = "Wojsko", DisplayName = "Rekrutacja zaawansowana", Description = "Efekt oryginału (kradzież zapasów z karawan) nie ma odpowiednika — karawany nie występują w tej wersji gry. Utrzymuje rabat złodziei 20%.", Level = 4, CostGold = 45000, ResearchTime = 25, CostScience = 12_000_000, RequiredTech = "Rekrutacja3", EffectType = "RecruitCostReduction", EffectValue = 0.20m },
            new TechnologyDefinition { Id = 46, TechType = "Rekrutacja5", Category = "Wojsko", DisplayName = "Rekrutacja nowoczesna", Description = "Efekt oryginału (ranni generałowie mają lvl/3) wymaga doprecyzowania źródła — odłożony. Utrzymuje rabat złodziei 20%.", Level = 5, CostGold = 80000, ResearchTime = 35, CostScience = 12_000_000, RequiredTech = "Rekrutacja4", EffectType = "RecruitCostReduction", EffectValue = 0.20m }
        );
    }
