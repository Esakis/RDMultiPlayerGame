...
namespace RedDragonAPI.Migrations
{
    ...
    [Migration("20260616093427_SyncResearchWithDracopedia")]
    partial class SyncResearchWithDracopedia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RedDragonAPI.Models.Entities.Era", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartedAt = new DateTime(2026, 6, 16, 9, 34, 26, 924, DateTimeKind.Utc).AddTicks(1398),
            ...
            modelBuilder.Entity("RedDragonAPI.Models.Entities.Kingdom", b =>
                {
                    ...
                    b.Property<int>("BloodElixirAttack")
                        .HasColumnType("int");

                    b.Property<int>("BloodElixirBloodlust")
                        .HasColumnType("int");

                    b.Property<int>("BloodElixirFocus")
                        .HasColumnType("int");

                    b.Property<int>("BloodElixirThief")
                        .HasColumnType("int");

                    b.Property<long>("BloodPoints")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RedDragonAPI.Models.Entities.TechnologyDefinition", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CostGold = 50000,
                            CostScience = 300000L,
                            Description = "Dodaje jednorazowo dwukrotny dzienny limit tur (ok. 30, z Wieżami Czasu 34). Do odkrycia w dowolnym momencie bez aktywności wojennej.",
